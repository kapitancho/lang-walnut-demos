...
withKeyValue          = ^[Map<String, 3..15>, String, Integer<2..10>] => Map<String|Integer<0..20>, 3..16>                                    :: #0->withKeyValue[key: #1, value: #2];
...
*/
    ...
    findFirstKeyValue: findFirstKeyValue[#e, ^[key: String, value: Integer<5..30>] => Boolean :: {#value == 12} && {#key == 'e'}],
    filterKeyValue: filterKeyValue[#e, ^[key: String, value: Integer<5..30>] => Boolean :: {#value > 15} || {#key == 'a'}],
